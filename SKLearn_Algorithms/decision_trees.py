...
clf = tree.DecisionTreeClassifier(criterion='gini', splitter='best', max_features=2836998)
...
y_kaggle_pred = clf.predict(word_counter_input_test)
...
to_submit.to_csv("submission_decision_trees.csv", index= False) #1st submission :)
